...
if __name__ == '__main__':
    notebook_dict = get_notebook_content()
    with open(r'd:\smartclaim\notebooks\SmartClaim_Colab_Pipeline.ipynb', 'w', encoding='utf-8') as f:
        json.dump(notebook_dict, f, ensure_ascii=False, indent=1)
    print("Notebook successfully created at d:\\smartclaim\\notebooks\\SmartClaim_Colab_Pipeline.ipynb")
